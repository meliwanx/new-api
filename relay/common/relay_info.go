...
type RelayInfo struct {
	...
	// WalletRestrictedQuotaConsumed is the wallet-billed quota currently consumed
	// from restricted quota. Refunds must restore this portion as restricted.
	WalletRestrictedQuotaConsumed int
