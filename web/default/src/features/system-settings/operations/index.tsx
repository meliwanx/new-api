...
const defaultOperationsSettings: OperationsSettings = {
  ...
  AffMultiLevelEnabled: false,
  AffCommissionRateL1: 0.1,
  AffCommissionRateL2: 0.05,
  AffCommissionRateL3: 0.02,
  AffCommissionMinRecharge: 0,
  AffCommissionValidityDays: 0,
  AffCommissionOnlyRealPay: true,
