	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/aff/invitees", controller.GetAffiliateInvitees)
				selfRoute.GET("/aff/withdrawals", controller.ListUserAffiliateWithdrawals)
				selfRoute.POST("/aff/withdrawals", middleware.CriticalRateLimit(), controller.CreateAffiliateWithdrawal)
				selfRoute.GET("/topup/info", controller.GetTopUpInfo)
				selfRoute.GET("/topup/self", controller.GetUserTopUps)
				selfRoute.POST("/topup", middleware.CriticalRateLimit(), controller.TopUp)
				selfRoute.POST("/invoice/request", middleware.CriticalRateLimit(), controller.CreateInvoiceRequest)
				selfRoute.GET("/invoice/:id/download", controller.DownloadUserInvoiceFile)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/invoice", controller.ListAdminInvoiceRequests)
				adminRoute.POST("/invoice/:id/process", controller.ProcessInvoiceRequest)
				adminRoute.POST("/invoice/:id/issue", controller.IssueInvoiceRequest)
				adminRoute.POST("/invoice/:id/upload", controller.UploadInvoiceFile)
				adminRoute.POST("/invoice/:id/reject", controller.RejectInvoiceRequest)
				adminRoute.GET("/invoice/:id/admin-download", controller.DownloadAdminInvoiceFile)
				adminRoute.GET("/affiliate-withdrawals", controller.ListAdminAffiliateWithdrawals)
				adminRoute.POST("/affiliate-withdrawals/:id/process", controller.ProcessAffiliateWithdrawal)
				adminRoute.POST("/affiliate-withdrawals/:id/complete", controller.CompleteAffiliateWithdrawal)
				adminRoute.POST("/affiliate-withdrawals/:id/reject", controller.RejectAffiliateWithdrawal)
		...
		supplierCardRoute := apiRouter.Group("/supplier-cards")
		{
			...
			supplierCardAdminRoute.Use(middleware.AdminAuth())
			{
				...
				supplierCardAdminRoute.GET("/suppliers", controller.AdminListSupplierCardSuppliers)
